...
import { _ModalBodySection as MBSection, _ModalBodySectionTitle as MBSectionTitle } from "../../../components/modal/modalLayout";
  ...
  return (
    <Modal title="How to Play" onClickClose={() => dispatch(setActiveModal(undefined))}>
      <MBSection>
        ...
        <p>Hints will help you find the secret colour.
          Your guess appears at the centre (tap it to take the colour chooser back to that guess).
          The colour at the edge shows the way toward the secret colour,
          but you will only be able to see some of the information you need depending on
          how close your guess is on each colour dimension (see below).
          And, if you're too far away, you may get no information about a dimension at all.
        </p>
        <p>
          The right and left edges guide you toward the correct saturation.
          The top and bottom edges guide you toward the correct brightness.
          The colour that you see all around the outer edge guides you toward the correct hue.
          (Beware, if you did not get any hint about the saturation, you will also not be
          able to see any hint you may have gotten about the hue.)
        </p>
      </MBSection>
      <MBSection>
        <MBSectionTitle>The Hue-Saturation-Brightness Colourspace</MBSectionTitle>
        <p>
          The chooser allows you navigate the Hue-Saturation-Brightness colour space.
        </p>
        <MobileView>
          <p>
            On a mobile device:
        ...
        <p>
          The 'hue' of a colour is basically where it lies on the rainbow,
          from red to purple and back to red again.
        </p>
        <p>
          ...
          A colour with 100% saturation will be vibrant, and will clearly show its hue (provided it is bright enough.)
        </p>
        <p>
          The 'brightness' (sometimes also called 'value') of a colour is basically
          how much light it emits (on your screen) or reflects (on a piece of paper).
