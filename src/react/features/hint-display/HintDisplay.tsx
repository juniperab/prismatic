...
function renderHintItem(hintItem: HintItem | undefined, name: string) {
    if (!hintItem) return <NoHintItemBox key={name}><span>&nbsp;</span></NoHintItemBox>
...
function renderHint(hint: Hint, idx: number) {
    const visitor: HintVisitor<[string, (HintItem | undefined)][]> = {
...
function renderAnswer(answerName: NamedColor | undefined, gaveUp: boolean) {
