...
import {
  ...
  ModalBody,
  ModalHeaderOuter,
  ModalHeaderSectionEdge, ModalHeaderSectionCentre, ModalIcon
} from "./modalLayout";
...
function ModalHeader(props: ModalHeaderProps): ReactElement {
  ...
  return <ModalHeaderOuter>
    <ModalHeaderSectionEdge style={{visibility: 'hidden'}}>
      {props.rightContent}
...
export function Modal(props: ModalProps): ReactElement {
  ...
  const closeButton = <ModalIcon onClick={props.onClickClose}>
    <theme.icons.close.svg />
  </ModalIcon>

  return <ModalBackground onClick={props.onClickClose}>
    <ModalOuter>
      <ModalInner onClick={e => e.stopPropagation()}>
        <ModalWindow>
          <ModalHeader
            centreContent={props.title}
