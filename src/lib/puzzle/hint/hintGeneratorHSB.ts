...
import {HintItem, HSBHint} from "../api/hint";
import {hueDiff, rotateHue} from "../../colour/colourMath";
import {PuzzleHSB} from "../api/puzzle";
...
function getHueHint(
    ...
    return {match: false, colour: {h: hue, s: Math.abs(value) * 100, b: 100}, value: value}
}
...
function getSaturationHint(
    ...
    return {match: false, colour: {h: guess.h, s: Math.abs(value) * 100, b: 100}, value: value}
}
...
function getBrightnessHint(
    ...
    return {match: false, colour: {h: guess.h, s: 0, b: Math.abs(1 - Math.abs(value)) * 100}, value: value}
}
