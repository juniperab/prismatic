...
function getRedHint(
    ...
    if (value > 0) {
        return {match: false, colour: toRGB({h: 0, s: 100 * (1 - value), b: 100}), value: value}
    } else {
        return {match: false, colour: toRGB({h: 180, s: 100 * (1 + value), b: 100}), value: value}
    }
}
...
function getGreenHint(
    ...
    if (value > 0) {
        return {match: false, colour: toRGB({h: 120, s: 100 * (1 - value), b: 100}), value: value}
    } else {
        return {match: false, colour: toRGB({h: 300, s: 100 * (1 + value), b: 100}), value: value}
    }
}
...
function getBlueHint(
    ...
    if (value > 0) {
        return {match: false, colour: toRGB({h: 240, s: 100 * (1 - value), b: 100}), value: value}
    } else {
        return {match: false, colour: toRGB({h: 60, s: 100 * (1 + value), b: 100}), value: value}
    }
}
